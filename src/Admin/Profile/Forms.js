               ...
               <Col md={12}>
                  ...
                  <div className="card">
                     <div className="card-body">
                        <Form.Group as={Row} className={this.state.errors.id_categories ? 'has-danger' : ''}>
                           <Form.Label column md={3}>Categories</Form.Label>
                           <Col md={9}>
                        ...
                        <Form.Group as={Row} className={this.state.errors.address ? 'has-danger' : ''}>
                           ...
                           <Col md={9}>
                              <Form.Control name="address" value={this.state.address} onChange={this._onChange} size="sm" />
                        ...
                        <Form.Group as={Row} className={this.state.errors.thumnail ? 'has-danger' : ''}>
                           ...
                           <Col md={9}>
                              <Form.Control name="thumbnail" ref={e => this.thumbnail = e} onChange={this._onChange} size="sm" type="file" />
